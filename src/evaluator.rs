        ...
        Expr::Binary { left, op, right } => {
            ...
            let total = match op {
                ...
                BinaryOp::Div => {
                    ...
                    // Divisão inteira trunca em direção a zero. Para os
                    // valores positivos que o SRD usa (ex: bônus de
                    // proficiência), isso equivale a floor(); fórmulas
                    // com resultado negativo podem se comportar
                    // diferente de floor() matemático — não é um caso
                    // real do SRD no MVP, então não vale complicar agora.
                    l / r
                }
            };
